...
namespace ui {
    ...
    void Root::createActions() {
        ...
        QAction *drawAct = toolbar->addAction(QIcon("://resources/icons/pencil.png"),"");
        connect(drawAct, &QAction::triggered, this, &Root::triggerDrawTool);
    ...
    void Root::triggerDrawTool() {
        DrawingTool *drawingTool = new DrawingTool(this,
                                                   imageDisplayLabel,
                                                   treatedImage,
                                                   pixMap,
                                                   &scaleFactor
        ...
        clearLayout(toolPanel->layout());
        toolPanel->layout()->addWidget(drawingTool);
    }
